...
const LightTunnel: React.FC<LightTunnelProps> = ({
  ...
  useEffect(() => {
    ...
    const program = new Program(gl, {
      ...
      uniforms: {
        ...
        uOpacity: { value: 1.0 },
        uCableColor: { value: new Float32Array([0.133, 0.772, 0.368]) },
        uPulseColor: { value: new Float32Array([0.29, 0.87, 0.502]) },
        uTunnelColor: { value: new Float32Array([0.062, 0.725, 0.505]) },
  ...
  return <div ref={containerRef} className={`absolute inset-0 h-full w-full overflow-hidden pointer-events-none z-0 ${className}`.trim()} />;
};
